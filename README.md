...
The climate data for Hawaii is provided through two CSV files. Use Python and Pandas to inspect the content of these files and clean the data.
...
Use SQLAlchemy to model table schemas and create a sqlite database for tables. One table for measurements and one for stations are needed.
...
* Create a Jupyter Notebook file called `climate_analysis.ipynb` and use it to complete climate analysis and data exporation.

* Choose a start date and end date for a trip. Make sure that vacation range is approximately 3-15 days total.
...
Design a Flask api based on the queries that have been just developed.
